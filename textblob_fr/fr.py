# -*- coding: utf-8 -*-
'''Code adapted from the pattern.fr library.
...
from textblob_fr.compat import unicode
...
from textblob_fr._text import (
    Lexicon, Spelling, Parser as _Parser,
    PUNCTUATION
)
...
replacements = {
  ...
  "puisqu'": "puisqu' ",
    ...
    u"(l|c|d|j|m|n|qu|s|t|jusqu|lorsqu|puisqu)’": u"\\1&rsquo; "
}
